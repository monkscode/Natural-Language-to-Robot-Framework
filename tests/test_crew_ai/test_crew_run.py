...
class TestRunCrewReturnShape:
    ...
    def test_fifth_element_is_the_shared_llm_wrapper(self):
        """result[4] is agents.llm itself — the shared CleanedLLMWrapper.

        workflow_service needs the wrapper, not just its monitor: it reads
