...
def _ensure_stub_learning_tables(conn) -> None:
    ...
    auth_isolated_schema sets search_path=auth_test with NO ,public fallback
    (see tests/test_auth/conftest.py), and the real bootstrap
