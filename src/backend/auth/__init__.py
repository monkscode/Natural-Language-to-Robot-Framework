...
Self-contained module that owns the ONLY PostgreSQL connection in the app (the
learning stack still uses SQLite/ChromaDB). Public surface:
...
- jwt_utils.require_user / require_admin / get_current_user — FastAPI deps used
  to guard endpoints (coexistence-aware via settings.AUTH_ENFORCED)
"""
